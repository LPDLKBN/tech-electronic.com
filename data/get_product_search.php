<?php  
function getSearchList($type,$keyarr,$curpage,$showrow,$act=""){
	global $unit;
	$cateClass = new Category;
	$result_arr=json_decode(Products::GetSearch($type,$keyarr,$curpage,$showrow));
	foreach ($result_arr as $rowbt){
        ...
        if ($series!="") {
        	$des=limit_words($comp,$series,440);
        } else {
