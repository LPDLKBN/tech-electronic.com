<?php
function GetProList($type,$brand,$series,$roundPrice,$dl,$dy,$attrType,$curpage,$showrow,$act="",$hasClass=false){
	global $unit;
	...
	if ($act==5||$act==6) {
    	...
    	$result_arr=json_decode(Products::GetAttr($type,$brand,$series,$roundPrice,$dl,$dy,$attrType,$curpage,$showrow));
	};
...
<?php } else if($act==2){ //列表页多列(热门产品页也用了此列表)?>
