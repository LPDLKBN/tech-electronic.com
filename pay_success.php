		...
		<div class="row align-items-center">
			<div class="col-lg-12">
				<div class="error-msg text-center">
					<h3 style="color: green">Successful payment</h3>
					<p>Your order has been paid successfully, and the page will automatically jump to the home page after <span class="times">5</span> seconds.</p>
				</div>
			</div>
		</div>
	</div>
